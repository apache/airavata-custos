...
struct UserProfile {
    ...
    1: required string userId,
    2: required string gatewayId,
    3: required Status State,
    4: required string userModelVersion = USER_PROFILE_VERSION,
    5: optional list<string> emails,
    ...
    17: optional i64 creationTime,
    18: optional i64 lastAccessTime,
    19: optional i64 validUntil,
