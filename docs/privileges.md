...
| `core:users:read`        | `GET /users`, `GET /users/{id}`, `GET` endpoints under `/user-identities*`, `GET /users/{id}/user-identities` (user identities are user records, so they share the `users` scope)                                                                                                                                                                                                                                                       |
