...
/**
 * Handles 'data_project_create' (DPC) and sends 'inform_transaction_complete' (ITC).
 */
@Component
public class DataProjectCreateHandler implements PacketHandler {
    ...
    private void sendSuccessReply(long packetRecId) {
        ...
        LOGGER.info("Successfully sent 'inform_transaction_complete' for packet_rec_id [{}].", packetRecId);
    }
}