...
// typed payload.
type ExternalIdentityHandler func(identity models.ExternalIdentity)

// SubscribeExternalIdentityCreated registers a typed handler invoked whenever
// an external_identity::create event is published.
...
// an external_identity::update event is published.
...
// an external_identity::delete event is published.
