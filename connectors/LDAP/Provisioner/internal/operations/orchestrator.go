...
// Orchestrator wraps the LDAP client and the core service. Exposes a
// single EnsurePOSIXAccount call that the subscriber invokes on every
// ComputeClusterUserCreateEvent it accepts.
