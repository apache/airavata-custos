...
_TENANTMANAGEMENTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getCredentials',
    full_name='org.apache.custos.tenant.management.service.TenantManagementService.getCredentials',
    index=6,
    containing_service=None,
    input_type=_GETCREDENTIALSREQUEST,
    output_type=_GETCREDENTIALSRESPONSE,
    serialized_options=b'\202\323\344\223\002\'\022%/tenant-management/v1.0.0/credentials',
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0027\0225/tenant-management/v1.0.0/tenants/{requesterUserName}',
  ),
  _descriptor.MethodDescriptor(
