...
import custos.core.TenantProfileService_pb2 as TenantProfileService__pb2
...
UpdateTenantRequest = _reflection.GeneratedProtocolMessageType('UpdateTenantRequest', (_message.Message,), dict(
...
GetCredentialsResponse = _reflection.GeneratedProtocolMessageType('GetCredentialsResponse', (_message.Message,), dict(
...
_GETTENANTRESPONSE_JWKSENTRY.has_options = True
_GETTENANTRESPONSE_JWKSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
