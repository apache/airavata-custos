...
import custos.coreCredentialStoreService_pb2 as CredentialStoreService__pb2
...
class IdentityManagementServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.authenticate = channel.unary_unary(
        ...
        request_serializer=IdentityManagementService__pb2.AuthenticationRequest.SerializeToString,
...
def add_IdentityManagementServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'authenticate': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=IdentityManagementService__pb2.AuthenticationRequest.FromString,
