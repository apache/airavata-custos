...
-- default_cluster.sql. Idempotent via ON CONFLICT DO NOTHING + deterministic IDs.
...
INSERT INTO projects (id, originated_id, title, origination, project_pi_id, status) VALUES
...
ON CONFLICT DO NOTHING;
INSERT INTO compute_allocations (id, project_id, name, status, compute_cluster_id, initial_su_amount, start_time, end_time) VALUES
...
ON CONFLICT DO NOTHING;
INSERT INTO compute_allocation_memberships (id, compute_allocation_id, user_id, start_time, end_time, membership_status) VALUES
...
ON CONFLICT DO NOTHING;
INSERT INTO compute_allocation_resource_mappings (id, compute_allocation_id, compute_allocation_resource_id, resource_amount, resource_time) VALUES
...
ON CONFLICT DO NOTHING;
INSERT INTO compute_allocation_usages (id, compute_allocation_id, used_raw_amount, used_su_amount, calculated_time, user_id, job_id, compute_allocation_resource_id) VALUES
...
ON CONFLICT DO NOTHING;
INSERT INTO compute_allocation_change_requests (id, compute_allocation_id, requested_su_amount, requested_status, reason, change_status, requester_id, approver_id, timestamp) VALUES
...
ON CONFLICT DO NOTHING;
INSERT INTO compute_allocation_change_request_events (id, compute_allocation_change_request_id, event_type, description, timestamp) VALUES
...
INSERT INTO compute_allocation_diffs (id, compute_allocation_id, diff_type, new_su_amount, status, timestamp, description) VALUES
