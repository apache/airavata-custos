...
INSERT INTO organizations (id, originated_id, name)
...
VALUES
    ('11111111-1111-1111-1111-111111111111', 'operator', 'Day-to-day AMIE and cluster operations (read + write)', FALSE),
    ('22222222-2222-2222-2222-222222222222', 'auditor',  'Read-only access across AMIE and cluster surfaces', FALSE),
    ('33333333-3333-3333-3333-333333333333', 'pi',       'Principal Investigator - manages own projects and allocations', FALSE)
ON CONFLICT DO NOTHING;
...
-- Role assignments
-- ---------------------------------------------------------------------------
INSERT INTO user_roles (user_id, role_id, granted_by, reason)
VALUES
    -- site staff
