...
-- Idempotent via ON CONFLICT DO NOTHING + deterministic IDs.
...
INSERT INTO compute_allocation_resource_rates (id, compute_allocation_resource_id, rate, start_time, end_time) VALUES
...
INSERT INTO compute_cluster_users (id, compute_cluster_id, user_id, local_username) VALUES
