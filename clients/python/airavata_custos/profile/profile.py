...
class Profile(object):
    ...
    def create_user(self, authorization_token, user_profile, tenant):
        """
        ...
        :param tenant identifier in which new user will be created
        :return: boolean true if user is created successfully otherwise false
        """
        return self.profile_service_pool.addUserProfile(authorization_token, user_profile, tenant)

    def update_user(self, authorization_token, user_profile, tenant):
        """
        ...
        """
        return self.updateUserProfile(authorization_token, user_profile, tenant)
