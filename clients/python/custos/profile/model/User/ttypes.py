...
class NSFDemographics(object):
    ...
    def __init__(self, userId=None, gatewayId=None, gender=None, usCitizenship=None, ethnicities=None, races=None, disabilities=None,):
        self.userId = userId
    ...
    def write(self, oprot):
        ...
        if self.usCitizenship is not None:
            oprot.writeFieldBegin('usCitizenship', TType.I32, 4)
            oprot.writeI32(self.usCitizenship)
            oprot.writeFieldEnd()
        if self.ethnicities is not None:
            oprot.writeFieldBegin('ethnicities', TType.LIST, 5)
        ...
        if self.races is not None:
            oprot.writeFieldBegin('races', TType.LIST, 6)
        ...
        if self.disabilities is not None:
            oprot.writeFieldBegin('disabilities', TType.LIST, 7)
    ...
    *
    ...
    def write(self, oprot):
        ...
        if self.labeledURI is not None:
            oprot.writeFieldBegin('labeledURI', TType.LIST, 21)
        ...
        if self.gpgKey is not None:
            oprot.writeFieldBegin('gpgKey', TType.STRING, 22)
            oprot.writeString(self.gpgKey.encode('utf-8') if sys.version_info[0] == 2 else self.gpgKey)
            oprot.writeFieldEnd()
        if self.timeZone is not None:
            oprot.writeFieldBegin('timeZone', TType.STRING, 23)
        ...
        if self.nsfDemographics is not None:
            oprot.writeFieldBegin('nsfDemographics', TType.STRUCT, 24)
...
NSFDemographics.thrift_spec = (
    ...
    (4, TType.I32, 'usCitizenship', None, None, ),  # 4
    (5, TType.LIST, 'ethnicities', (TType.I32, None, False), None, ),  # 5
    (6, TType.LIST, 'races', (TType.I32, None, False), None, ),  # 6
    (7, TType.LIST, 'disabilities', (TType.I32, None, False), None, ),  # 7
)
...
UserProfile.thrift_spec = (
    ...
    (23, TType.STRING, 'timeZone', 'UTF8', None, ),  # 23
    (24, TType.STRUCT, 'nsfDemographics', [NSFDemographics, None], None, ),  # 24
)
