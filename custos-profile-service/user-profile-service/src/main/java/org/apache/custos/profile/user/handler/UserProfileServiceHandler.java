 ...
 *
*/
package org.apache.custos.profile.user.handler;
...
public class UserProfileServiceHandler implements UserProfileService.Iface {
    ...
    @Override
    public boolean doesUserExist(AuthzToken authzToken, String userId, String gatewayId) throws UserProfileServiceException{
        try{
            UserProfile userProfile = userProfileRepository.getUserProfileByIdAndGateWay(userId, gatewayId);
    ...
    private IamAdminServices.Client getIamAdminServicesClient() throws UserProfileServiceException {
        try {
            ...
            return CustosIamAdminServiceClient.createCustosIamAdminServiceClient(serverHost, serverPort);
