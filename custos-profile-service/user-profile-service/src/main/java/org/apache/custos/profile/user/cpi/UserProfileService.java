...
public class UserProfileService {
  ...
  public interface Iface {
    ...
    public org.apache.custos.profile.model.user.UserProfile deleteUserProfile(org.apache.custos.commons.model.security.AuthzToken authzToken, String userId, String gatewayId) throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException;

    public java.util.List<org.apache.custos.profile.model.user.UserProfile> getAllUserProfilesInGateway(org.apache.custos.commons.model.security.AuthzToken authzToken, String gatewayId, int offset, int limit) throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException;

    public boolean doesUserExist(org.apache.custos.commons.model.security.AuthzToken authzToken, String userId, String gatewayId) throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public org.apache.custos.profile.model.user.UserProfile recv_initializeUserProfile() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
    ...
    public org.apache.custos.profile.model.user.UserProfile recv_addUserProfile() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
    ...
    public org.apache.custos.profile.model.user.UserProfile recv_updateUserProfile() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
    ...
    public org.apache.custos.profile.model.user.UserProfile recv_getUserProfileById() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
    ...
    public org.apache.custos.profile.model.user.UserProfile recv_deleteUserProfile() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
    ...
    public java.util.List<org.apache.custos.profile.model.user.UserProfile> recv_getAllUserProfilesInGateway() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
    ...
    public boolean recv_doesUserExist() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class initializeUserProfile_call extends org.apache.thrift.async.TAsyncMethodCall<org.apache.custos.profile.model.user.UserProfile> {
      ...
      public org.apache.custos.profile.model.user.UserProfile getResult() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class addUserProfile_call extends org.apache.thrift.async.TAsyncMethodCall<org.apache.custos.profile.model.user.UserProfile> {
      ...
      public addUserProfile_call(org.apache.custos.commons.model.security.AuthzToken authzToken, org.apache.custos.profile.model.user.UserProfile userProfile, String clientId, String clientSecret, org.apache.thrift.async.AsyncMethodCallback<org.apache.custos.profile.model.user.UserProfile> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.authzToken = authzToken;
    ...
    public static class getAllUserProfilesInGateway_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<org.apache.custos.profile.model.user.UserProfile>> {
      ...
      public java.util.List<org.apache.custos.profile.model.user.UserProfile> getResult() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class doesUserExist_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      ...
      public Boolean getResult() throws org.apache.custos.profile.user.cpi.exception.UserProfileServiceException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
