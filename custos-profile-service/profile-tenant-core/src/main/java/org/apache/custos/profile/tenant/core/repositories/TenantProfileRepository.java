 ...
 *
 */
package org.apache.custos.profile.tenant.core.repositories;
...
public class TenantProfileRepository extends AbstractRepository<Gateway, GatewayEntity, String> {
    ...
    public Gateway getGateway (String custosInternalGatewayId) throws Exception {
    ...
    public Gateway getGatewayUsingId (String gatewayId) throws Exception {
        Gateway gateway = null;
        try {
            Map<String, Object> queryParam = new HashMap<String, Object>();
