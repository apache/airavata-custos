...
public class UserGroup implements org.apache.thrift.TBase<UserGroup, UserGroup._Fields>, java.io.Serializable, Cloneable, Comparable<UserGroup> {
  ...
  public UserGroup setGroupId(@org.apache.thrift.annotation.Nullable String groupId) {
  ...
  public UserGroup setDomainId(@org.apache.thrift.annotation.Nullable String domainId) {
  ...
  public UserGroup setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UserGroup setDescription(@org.apache.thrift.annotation.Nullable String description) {
  ...
  public UserGroup setOwnerId(@org.apache.thrift.annotation.Nullable String ownerId) {
  ...
  public int compareTo(UserGroup other) {
    ...
    lastComparison = Boolean.valueOf(isSetGroupAdmins()).compareTo(other.isSetGroupAdmins());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGroupAdmins()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserGroup struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // GROUP_CARDINALITY
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.groupCardinality = org.apache.custos.sharing.registry.models.GroupCardinality.findByValue(iprot.readI32());
