...
public class GroupAdmin implements org.apache.thrift.TBase<GroupAdmin, GroupAdmin._Fields>, java.io.Serializable, Cloneable, Comparable<GroupAdmin> {
  ...
  public @org.apache.thrift.annotation.Nullable String adminId; // optional
  ...
  public GroupAdmin setGroupId(@org.apache.thrift.annotation.Nullable String groupId) {
  ...
  public GroupAdmin setDomainId(@org.apache.thrift.annotation.Nullable String domainId) {
  ...
  public GroupAdmin setAdminId(@org.apache.thrift.annotation.Nullable String adminId) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GroupAdmin(");
    boolean first = true;
