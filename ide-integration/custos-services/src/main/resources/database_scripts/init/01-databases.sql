...
CREATE TABLE `NSF_DEMOGRAPHIC` (
  ...
  CONSTRAINT `nsf_demographic_ibfk_1` FOREIGN KEY (`USER_ID`, `GATEWAY_ID`) REFERENCES `USER_PROFILE` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `NSF_DEMOGRAPHIC_DISABILITY` (
  ...
  CONSTRAINT `nsf_demographic_disability_ibfk_1` FOREIGN KEY (`USER_ID`, `GATEWAY_ID`) REFERENCES `NSF_DEMOGRAPHIC` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `NSF_DEMOGRAPHIC_ETHNICITY` (
  ...
  CONSTRAINT `nsf_demographic_ethnicity_ibfk_1` FOREIGN KEY (`USER_ID`, `GATEWAY_ID`) REFERENCES `NSF_DEMOGRAPHIC` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `NSF_DEMOGRAPHIC_RACE` (
  ...
  CONSTRAINT `nsf_demographic_race_ibfk_1` FOREIGN KEY (`USER_ID`,`GATEWAY_ID`) REFERENCES `NSF_DEMOGRAPHIC` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `USER_PROFILE_EMAIL` (
  ...
  CONSTRAINT `user_profile_email_ibfk_1` FOREIGN KEY (`USER_ID`,`GATEWAY_ID`) REFERENCES `USER_PROFILE` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `USER_PROFILE_LABELED_URI` (
  ...
  CONSTRAINT `user_profile_labeled_uri_ibfk_1` FOREIGN KEY (`USER_ID`, `GATEWAY_ID`) REFERENCES `USER_PROFILE` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `USER_PROFILE_NATIONALITY` (
  ...
  CONSTRAINT `user_profile_nationality_ibfk_1` FOREIGN KEY (`USER_ID`, `GATEWAY_ID`) REFERENCES `USER_PROFILE`(`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `USER_PROFILE_PHONE` (
  ...
  CONSTRAINT `user_profile_phone_ibfk_1` FOREIGN KEY (`USER_ID`, `GATEWAY_ID`) REFERENCES `USER_PROFILE` (`USER_ID`, `GATEWAY_ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
