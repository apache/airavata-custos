...
/**
 * Maps to the 'project_memberships' table. Links cluster accounts to projects with roles.
 */
@Entity
@Table(name = "project_memberships", uniqueConstraints = {@UniqueConstraint(columnNames = {"project_id", "cluster_account_id"})})
